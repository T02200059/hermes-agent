...
def delegate_task(
    ...
    for i, t in enumerate(task_list):
        ...
        child = _build_child_preserving_parent_tools(
            ...
            # Prefer task-level acp overrides; fall back to delegation creds
            # (owner fix for NameError on removed free-vars; #acp_args).
            override_acp_command=t.get("acp_command") or creds.get("command"),
            override_acp_args=(
