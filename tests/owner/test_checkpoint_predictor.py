...
def test_safe_roots_drops_home_and_root(mock_agent, monkeypatch):
    ...
    # LLM 返回一个 home 下的路径 → 项目根是 home → 丢弃
    class _FakeResp:
        class _Choice:
            class _Msg:
                content = '["~/foo.txt"]'
    ...
    # get_working_dir_for_path 对 ~/foo.txt 返回 home
