...
def _run_job_script_with_claim_heartbeat(
    job: dict, script_path: str, args: Optional[dict] = None, workdir: Optional[str] = None,
) -> tuple[bool, str]:
    ...
    def _run() -> tuple[bool, str]:
        ...
        if args is None and workdir is None:
            return _run_job_script(script_path)
        return _run_job_script(script_path, args=args, workdir=workdir)
