...
241|- [x] ✅ 已迁移（cron args + model_extra_body；backup scripts 按决策忽略）`37e6fba` → `b84b43927` | 2026-05-21 | `yangtb` | feat: model-level extra_body injection + cron args + backup scripts | +634 | −112 |
