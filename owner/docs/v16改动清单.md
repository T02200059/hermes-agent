...
> **范围**：owner-v16 分支，从首个杨天宝提交 `17e4a81a8` 到当前 HEAD `a2703ab86`（含 sync upstream/main merge）  
> **最后更新**：2026-06-20（sync fork：merge upstream b88d0007c，445 commits；§11.7 sync 复盘）  
