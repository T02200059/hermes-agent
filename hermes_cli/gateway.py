...
# [owner] launchd restart: using upstream improved drain/kickstart/bootstrap
# logic (batch 22+). Owner custom label/domain/plist/fallback behaviors
# continue to work via the helper functions defined earlier in this file.
# Deep strategy customization can still live in owner.gateway.launchd_restart if needed.
